...
<Columns cols={2}>
  ...
  <Card title="Embedding models" icon="sitemap" href="/oss/javascript/integrations/embeddings" arrow cta="Learn more">
...
<Card title="Tutorial: Retrieval-Augmented Generation (RAG)" icon="robot" href="/oss/javascript/deepagents/rag" arrow cta="Learn more">
