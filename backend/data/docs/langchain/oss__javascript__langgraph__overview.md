...
<Columns cols={1}>
  ...
  <Card title="LangChain" icon="https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-icon.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=663b30f85baf99ad708b97e05da2a5a4" href="/oss/javascript/langchain/overview" arrow cta="Learn more" width="195" height="195" data-path="images/brand/langchain-icon.png">
